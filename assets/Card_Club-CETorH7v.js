import{u as c,j as e}from"./index-DQDoNcKn.js";import{T as i}from"./Chip_type-C_fRQfhd.js";const m=({club:l,variant:n="home"})=>{const{clubId:x,profileImageUrl:o,clubType:r,clubName:a}=l,p=c(),s=()=>{p(`/clubs/${x}`,{state:{clubType:r}})},t=n==="explore";return e.jsxs("div",{onClick:s,role:"button",tabIndex:0,className:`
